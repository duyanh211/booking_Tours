...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Cập nhật gói tour </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
  	       <h3>Cập nhật thông tin gói tour</h3>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagetype" id="packagetype" placeholder=" Loại gói " value="<?php echo htmlentities($result->PackageType);?>" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagelocation" id="packagelocation" placeholder=" Địa chỉ" value="<?php echo htmlentities($result->PackageLocation);?>" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" VND" value="<?php echo htmlentities($result->PackagePrice);?>" required>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagefeatures" id="packagefeatures" placeholder="VD: Ăn uống/Nhảy múa" value="<?php echo htmlentities($result->PackageFetures);?>" required>
									</div>
								</div>		
...
<div class="col-sm-8">
<img src="pacakgeimages/<?php echo htmlentities($result->PackageImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->PackageId);?>">Đổi ảnh</a>
</div>
</div>

<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Lần cuối cập nhật</label>
									<div class="col-sm-8">
