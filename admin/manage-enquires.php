...
<html>
<head>
<title>A-3T | Admin quản lý đánh giá</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Quản lý đánh giá</li>
            </ol>
...
<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn muốn xem ?')" >Xác nhận</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
